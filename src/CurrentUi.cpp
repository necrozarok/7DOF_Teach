#include "CurrentUi.h"
#include "ui_CurrentUi.h"
#pragma execution_character_set("utf-8")
CurrentUi::CurrentUi(QWidget *parent)
	: QWidget(parent)
{
	ui = new Ui::CurrentUi();
	ui->setupUi(this);
...
void CurrentUi::init(EPOS * e_object, Dynamixel * dy_object)
{
	epos_object = e_object;
	dynamixel_object = dy_object;
}
void CurrentUi::setupDemo(int demoIndex)
{
	switch (demoIndex)
	{
	...
	setWindowTitle("电流监控: " + demoName);
	//statusBar->clearMessage();
	currentDemoIndex = demoIndex;
	ui->customPlot->replot();
}

void CurrentUi::setupQuadraticDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupSimpleDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupSincScatterDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupScatterStyleDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupLineStyleDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupScatterPixmapDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupDateDemo(QCustomPlot *customPlot)
{
	demoName = "Date Demo";
...
void CurrentUi::setupTextureBrushDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupMultiAxisDemo(QCustomPlot *customPlot)
{
	...
	customPlot->legend->setVisible(true);
	QFont legendFont = font();  // start out with CurrentUi's font..
...
void CurrentUi::setupLogarithmicDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupRealtimeDataDemo(QCustomPlot *customPlot)
{
	demoName = "Real Current Data";
	customPlot->legend->setVisible(true);
	customPlot->legend->setFont(QFont("Helvetica", 9));
	// axis configurations:
...
void CurrentUi::setupParametricCurveDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupBarChartDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupStatisticalDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupSimpleItemDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupItemDemo(QCustomPlot *customPlot)
{
	demoName = "Item Demo";
	...
	// setup a timer that repeatedly calls CurrentUi::bracketDataSlot:
	connect(&dataTimer, SIGNAL(timeout()), this, SLOT(bracketDataSlot()));
	dataTimer.start(0); // Interval 0 means to refresh as fast as possible
}

void CurrentUi::setupStyledDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupAdvancedAxesDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupColorMapDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::setupFinancialDemo(QCustomPlot *customPlot)
{
...
void CurrentUi::realtimeDataSlot()
{
...
void CurrentUi::bracketDataSlot()
{
...
void CurrentUi::setupPlayground(QCustomPlot *customPlot)
{
	Q_UNUSED(customPlot)
}

void CurrentUi::screenShot()
{
